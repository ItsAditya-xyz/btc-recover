...
SUFFIXES = ["", "1","2","3","12","123","1234","12345","01","00","11",
            ...
            "!","!!","?",".","#","$","*","123!","2013!","1969!","21!",
            "_","-","2013.","69!","00!",
            "*","5*","6*","7*","8*","5678*","69*","1969*",       # * suffix confirmed (pera5luz*)
            "@1","@2","@5","@6","@7","@8","@69","@2013",         # @ suffix variants
            "%1","%5","%6","%7","%8","%69",                      # % suffix variants
            "16","2316","116","169","691"]                        # 16 from trello arielramirez16
PREFIXES = ["", "!", "1", "0", "#"]
SEPS = ["", " ", ".", "_", "-", "2013", "13", "21",
        "5","6","7","8","56","57","58","67","68","78","567","5678",  # survey digits
        "0","1","2","3","4","9",       # all single digits (other accts use non-survey digits)
        "@","%"]                        # confirmed separators from breach data (pera%lus, Pera@chocolate5)
